...
gname='dsa'
tname='ginn'
nam_gen='Kasthuri15_resize_450000' 
...
path_dirs_show=[f'loss_{weight}',f'loss_3',f'loss_1']
...
param['neld_names_all']['param']=neld_namess=  [f'd{str(i).zfill(3)}' for i in range(3)]
