...
dnn_mode=dict_param['dnn_modes'][dict_param['dyna']['dnn_mode_index']]


path_heads_show=dict_param['path_heads_show']
model_type=path_heads_show[dict_param['dyna']['model_type_index']] 

path_dirs_show=dict_param['path_dirs_show']
path_dir=path_dirs_show[dict_param['dyna']['path_dir_index']]
...
param['riplet']['param']['den_Circon']=dict_param['dyna']['riplet']
