...
from mod.dsa.dend_fun_0.density import get_cylinder
from mod.dsa.dend_fun_0.ripley import get_riplet
 ...
 '''
    ...
    def get_head_neck_segss(self,    
        ...
        if len(metrics_dat)>0:
            ...
            os.makedirs(spine_path_save,exist_ok=True)
        ...
        for head_neck_path in self.path_display:
            ...
            for  index,neld_name in enumerate(neld_names):
                ...
                for true_path,true_key in self.neld_path_original_mm['keys'].items() : 
                    ...
                    path_grap_true=os.path.join(neld_path_true_final ,'intensity_1hot_shaft_spine.txt') 
    ...
    def get_cylinder_heatmap(self,   
        ...
        for  index,neld_name in enumerate(neld_names):
            ...
            for center_path in self.path_display: 
                ...
                count_path=os.path.join(spine_path,self.txt_shaft_vcv_length )
                if os.path.exists(count_path):
                    gcyl=get_cylinder( pid, spine_path=spine_path)
                    gcyl() 
                else:
    ...
    def get_riplet(self,   
        ...
        for  index,neld_name in enumerate(neld_names):
            ...
            for center_path in self.path_display: 
                ...
                count_path=os.path.join(spine_path,self.txt_shaft_vcv_length )
                if os.path.exists(count_path):
                    gcyl=get_riplet( pid, spine_path=spine_path)
                    gcyl(
    ...
    def get_dash_pages(self,  
        ...
        from neld_data_all import tname,path_dict,params,paraws,path_file_dir_text,file_path_org_text,file_path_data_text,nam_gen
        ...
        for index,neld_name in enumerate(neld_names):   
            ...
            get_text_dash_test(type='d000',
                                ...
                                file_path_data=file_path_data_text,
