...
from mod.dsa.neld_fun_0.main_0_help import get_dict_param ,get_navs_bar
from  mod.dsa.neld_fun_0.main_0_help import box_style,dropdown_style,dropdown_options_style
from mod.dsa.neld_fun_0.main_0_help import async_shutdown,async_restart
...
from mod.dsa.neld_fun_0.help_funn import remove_directory
import threading 
  
import os
import dash
from dash import html, Input, Output, State, callback, ctx, ALL 
# from mod.dsa.neld_fun_0.main_0 import (
...
class DSAPage(dropdown_callback,algorithm,model_pred):
    ...
    def __init__(self,path_heads_show=None,categories=None,path_display=None,dnn_modes=None,nam_gen_show=None,tname=None,path_dict=None):
        ...
        if os.path.exists(path_dir):
            ...
            pinn_dir_data_all=[mm for mm in list(np.loadtxt(path_dir,dtype=str))+['None',]]
