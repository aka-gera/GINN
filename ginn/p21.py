...
param['neld_names_all']['param']=neld_namess=  [f'd{str(i).zfill(3)}' for i in range(6)]
...
neld_names = ['BTLNG_d004_RECON','BTLNG_d005_RECON','BTLNG_d010_RECON','CNJVY_d001_RECON','CNJVY_d003_RECON','CNJVY_d005_RECON',]   
neld_last = ['BTLNG', 'BTLNG', 'BTLNG', 'CNJVY', 'CNJVY', 'CNJVY', ] 
neld_first = ['d004', 'd005',  'd010',  'd001', 'd003',  'd005', ]   
'''
obj_list=[1,2]
# obj_list=[62,63]
