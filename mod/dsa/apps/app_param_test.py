...
class app_param(get_app_param,class_data,get_layout,dropdown_callback,algorithm,model_pred): 
    def __init__(self, file_path_org, 
        ...
        # file_path_org = os.path.join(*file_path_org)
        # file_path_org=os.path.join(os.getcwd(),'files')
        path_dir=os.path.join(file_path_org, 'data')
        path_dir=os.path.join(file_path_org, 'data')
        self.file_path_data= os.path.join(file_path_org, 'data_initial')
        print('999[[[[[[[]]]]]]]',path_dir,file_path_org)
...
'''
        ...
        if not os.path.exists(path_file_dir):
            path_file_dir=os.path.join(os.getcwd(),'files','dsa','dinn','data_initial','meshes')
        ...
        get_files.__init__(self,**self.pari,
                            # neld_data=neld_data,
                            # file_path_org=file_path_org,
                            # neld_names=neld_names,
                            # neld_namess=neld_namess, 
